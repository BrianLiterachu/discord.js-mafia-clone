        ...
        function(error, response, body) {
            ...
            if (response && response.statusCode == 200) {
                ...
                const image = {
                    ...
                    author: {
                        name: message.author.username + Language.kissTextBefore + message.mentions.users.first().username + Language.kissTextAfter + "\n" + text,
...
module.exports.config = {
    name: "kiss",
    description: Language.help.kiss,
    usage: "r!kiss <mention>",
