        ...
        function(error, response, body) {
            ...
            if (response && response.statusCode == 200) {
                ...
                const image = {
                    ...
                    author: {
                        name: message.author.username + Language.slapTextBefore + message.mentions.users.first().username + Language.slapTextAfter + "\n" + text,
...
module.exports.config = {
    name: "slap",
    description: Language.help.slap,
    usage: "r!slap <mention>",
