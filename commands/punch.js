        ...
        function(error, response, body) {
            ...
            if (response && response.statusCode == 200) {
                ...
                const image = {
                    ...
                    author: {
                        name: message.author.username + Language.punchTextBefore + message.mentions.users.first().username + Language.punchTextAfter + "\n" + text,
...
module.exports.config = {
    name: "punch",
    description: Language.help.punch,
    usage: "r!punch <mention>",
